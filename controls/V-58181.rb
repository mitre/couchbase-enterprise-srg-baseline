  ...
  "
  desc  "fix", "
  Where dynamic code execution is used, modify the code to
  ...
  tag "nist": ["SI-10", "Rev_4"]
    ...
    describe "This test requires a Manual Review: Review Couchbase source code (stored procedures, functions,
    triggers) and application source code to identify cases of dynamic code execution." do
      skip "This test requires a Manual Review: Review Couchbase source code (stored procedures, functions,
      triggers) and application source code to identify cases of dynamic code execution."
    end 

    describe "This test requires a Manual Review:	If dynamic code execution is employed without protective 
    measures against code injection, this is a finding." do
      skip "This test requires a Manual Review: If dynamic code execution is employed without protective 
