...
the system denies or fails to complete attempts to retrieve
...
when the DBMS denies retrieval of privileges/permissions/role memberships.
...
denies or fails to complete access to privileges/permissions/role membership.
    ...
    If currently required, configure the DBMS to produce audit records when it
