...
control "V-58153" do
  ...
  describe "This test requires a Manual Review: Verify that Couchbase is employing protective measures against unauthorized
  disclosure and modification during preparation for transmission, if not this is a finding." do
    skip "This test requires a Manual Review: Verify that Couchbase is employing protective measures against unauthorized
    disclosure and modification during preparation for transmission, if not this is a finding."
  end
