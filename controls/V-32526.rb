...
control "V-32526" do
  ...
  describe "This test requires a Manual Review: Review Couchbase settings and 
  vendor documentation to determine whether Couchbase recognizes session identifiers 
  that are not system-generated" do
    skip "This test requires a Manual Review: Review Couchbase settings and 
    vendor documentation to determine whether Couchbase recognizes session identifiers 
