...
is not a finding.
    ...
    If the documentation requires automatic session termination, but the DBMS
is not configured accordingly, this is a finding.
  "
  desc  'fix', "Configure the DBMS to automatically terminate a user session
