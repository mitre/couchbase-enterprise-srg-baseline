...
the system denies or fails to complete attempts to access categories of
...
audit records are produced when the system denies attempts to access categories
of information, such access to include reads, creations, modifications and
deletions.
...
denies or fails to complete access to categories of information.
