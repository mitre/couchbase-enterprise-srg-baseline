...
control "V-58083" do
  ...
  Verify the events were logged with the following command:
    ...
    created\",\"id\":8201,\"name\":\"create bucket\",
    \"props\":{\"compression_mode\":\"passive\",\"conflict_resolution_type\":
    \"seqno\", \"durability_min_level\":\"none\",\"eviction_policy\":\"value_only\",
    \"flush_enabled\":false,\"max_ttl\":0,\"num_threads\":3,\"ram_quota\":268435456,
    \"replica_index\":true,\"storage_mode\":\"couchstore\"},\"real_use\"rid\"\":{\"domain\":
    \"local\",\"user\":\"jdoe\"},\"remote\":{\"ip\":\"127.0.0.1\",\"port\":45934},\"timestamp\":
    \"2020-08-20T20:30:34.115Z\",\"type\":\"membase\"}
  ...
  describe "Create a Bucket as jdoe. The" do 
